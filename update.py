    ...
    itinerary = [
        {
            ...
            "desc": """
                ...
                • <b>第二程：</b>香港 (HKG) 12:35 ➔ 巴厘岛 (DPS) 17:35 (CX785)
            """,
            "pois": [
                {
                    "name": "巴厘岛国际机场 (DPS)", 
                    ...
                    "info": "✈️ 入境大厅 | 耗时: 1-1.5h | 费用: VOA 50万印尼盾",
                ...
                },
                {
                    ...
                    "lat": -8.7941, "lon": 115.2302, "type": "hotel", 
                    "img": "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=400&q=80",
                    "info": "🏨 亲子酒店 | 晚餐建议: Ikan (海滨烧烤)",
                    "link": "https://www.tripadvisor.cn/Hotel_Review-g297698-d302324-Reviews-The_Westin_Resort_Nusa_Dua_Bali-Nusa_Dua_Nusa_Dua_Peninsula_Bali.html"
                }
            ],
            "tips": "🛡️ <b>导游建议：</b>抵达后先去换少量印尼盾用于支付接机小费，其余可刷卡。"
        },
        {
            "day": 2,
            "date": "2月12日",
            "title": "努沙杜瓦：阳光、沙滩与童话",
            "hotel": "The Westin Resort Nusa Dua",
            "desc": "上午参加威斯汀儿童俱乐部的活动。下午前往海盗湾餐厅，在巨大的海盗船和树屋上用餐。",
            "pois": [
                {
                ...
                },
                {
                    ...
                    "info": "🏴‍☠️ 主题餐厅 | 建议停留: 2h | 人均: 20-30 USD",
            ...
            "tips": "💡 导游建议：Kids Club 建议提前 1 天预约手工课程。"
        },
        {
            "day": 3,
            "date": "2月13日",
            "title": "悬崖日落与海上火舞",
            "hotel": "The Westin Resort Nusa Dua",
            "desc": "参观 Waterblow，观看巨浪。傍晚在乌鲁瓦图情人崖观看 Kecak 舞蹈表演。",
            "pois": [
                {
                    ...
                    "info": "🌅 日落胜地 | 演出时间: 18:00 | 门票: 约 15万印尼盾",
        ...
        },
        {
            ...
            "desc": "退房后前往乌布，中途停留瀑布，随后入住 Maya Ubud 森林酒店。",
            "pois": [
                {
                    "name": "Maya Ubud Resort", 
                    "lat": -8.5081, "lon": 115.2758, "type": "hotel", 
                    "img": "https://images.unsplash.com/photo-1559628233-eb1b1a45564b?auto=format&fit=crop&w=400&q=80",
                    "info": "🌿 丛林酒店 | 亮点: 无边泳池 | 活动: 晨间瑜伽",
                    "link": "https://www.tripadvisor.cn/Hotel_Review-g297701-d305615-Reviews-Maya_Ubud_Resort_Spa-Ubud_Gianyar_Regency_Bali.html"
                },
                {
                    "name": "Bebek Bengil (脏鸭餐)", 
        ...
        },
        {
            ...
            "title": "丛林里的精灵与亲子下午茶",
            "hotel": "Maya Ubud Resort & Spa",
            "desc": "在圣猴森林看猴子，在 Milk & Madu 享用完美的亲子餐。",
            "pois": [
                {
                    "name": "圣猴森林", 
        ...
        },
        {
            ...
            "title": "绿色梯田与圣泉洗礼",
            "hotel": "Maya Ubud Resort & Spa",
            "desc": "探访标志性的 Tegalalang 梯田，并在圣泉寺体验洗礼。",
            "pois": [
                {
                    "name": "Tegalalang 梯田", 
                    ...
                    "info": "🌾 绝美梯田 | 最佳时间: 08:30 | 费用: 捐赠制/小额门票",
                ...
                },
                {
                    ...
                    "lat": -8.4162, "lon": 115.2895, "type": "attraction", 
                    "img": "https://images.unsplash.com/photo-1596701062351-be1ef9a33c8a?auto=format&fit=crop&w=400&q=80",
                    "info": "🙏 宗教圣地 | 建议停留: 1.5h | 需穿沙龙 (可现场租)",
                    "link": "https://www.tripadvisor.cn/Attraction_Review-g297701-d379331-Reviews-Tirta_Empul_Temple-Ubud_Gianyar_Regency_Bali.html"
                }
            ],
            "tips": "📸 梯田有很多秋千 (Swing)，适合拍照，但要注意宝宝安全。"
        },
        {
            "day": 7,
            "date": "2月17日",
        ...
        function updateDay(day) {
            ...
            document.getElementById('dayContent').innerHTML = `
                <div class="itinerary-card">
                    ...
                    <h3 style="font-size: 15px; margin-bottom: 12px; color: var(--text-sub);">📍 行程详情:</h3>
                    ${poisHtml}
                </div>
            `;
            ...
            data.pois.forEach(p => L.marker([p.lat, p.lon]).addTo(markersGroup).bindPopup(p.name));
            if (latlngs.length > 1) {
